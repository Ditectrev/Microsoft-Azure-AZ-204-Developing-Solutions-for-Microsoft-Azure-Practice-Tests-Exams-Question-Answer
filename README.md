...
| 9   | [You are developing an Azure Web App. You configure TLS mutual authentication for the web app. You need to validate the client certificate in the web app.](#question9) |
...
### You are developing a web service that will run on Azure virtual machines that use Azure Storage. You configure all virtual machines to use managed identities. You have the following requirements: Secret-based authentication mechanisms are not permitted for accessing an Azure Storage account. Must use only Azure Instance Metadata Service endpoints. You need to write code to retrieve an access token to access Azure Storage. Code segment 1 [???]
...
### You are developing an Azure solution to collect inventory data from thousands of stores located around the world. Each store location will send the inventory data hourly to an Azure Blob storage account for processing. The solution must meet the following requirements: Begin processing when data is saved to Azure Blob storage. Filter data based on store location information. Trigger an Azure Logic App to process the data for output to Azure Cosmos DB. Enable high availability and geographic distribution. Allow 24-hours for retries. Implement an exponential back off data processing. You need to configure the solution. What should you implement? [Missing image in question???]
...
![Question 119 part 1](images/question119_1.png)
![Question 119 part 2](images/question119_2.png)
![Question 119 part 3](images/question119_3.png)
![Question 119 part 4](images/question119_4.png)
...
- [ ] Box 1: Configure a Scale condition. Box 2: SecretClient.
...
- [x] Box 1: Create a blank Logic app. Box 2: Add a ogic app action that fres when one or
more messages amive in the queue. Box 3: Add an action that reads o temperature.
